        ...
        \resumeItemListStart{}
            ...
            \begin{itemize}[leftmargin=0.5in, label={\textbullet}]
                ...
                conducted vulnerability scanning with enforced DevSecOps practices within CI/CD pipelines. Also implemented role-based access control (RBAC)
                 ...
                 \item Performed on-prem applications security scanning using OWASP ZAP, BurpSuit.
                 \item Performed source code analysis using SonarQube, CodeCoverage, and CodeAnalysis, also VAPT and API testing using Postman.
                 \item Proficient in understanding and executing application level vulnerability attacks like -XSS (Cross Site Scripting), SQL injection, 
                 CSRF (Cross Site Request Forgery), Session
                 \item Implemented Azure security best practices, including RBAC, Azure Policy, and Key Vault integration to ensure secure and compliant 
                 cloud environments.
                 \item Monitored and responded to security threats using Microsoft Defender for Cloud and Azure Sentinel, enhancing overall cloud security 
